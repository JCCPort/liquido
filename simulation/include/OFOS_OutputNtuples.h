...
public:
    OFOS_OutputNtuples(const char *h_name, const char *h_title, int n_max_hits, const char *i_name, const char *i_title,
                       int n_max_interactions);
    ...
    bool
    fill_interaction(int track_id, int parent_id, int interaction_id, int particle, const G4ThreeVector &pos, float dE,
                     float E, float time);
